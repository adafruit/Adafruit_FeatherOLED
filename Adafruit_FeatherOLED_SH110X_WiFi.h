/*!
 * @file     Adafruit_FeatherOLED_SH110X_WiFi.h
 */

#ifndef _Adafruit_FeatherOLED_SH110X_WiFi_H_
/*!
 @brief Adafruit FeatherOLED SH110X WiFi H
 */
#define _Adafruit_FeatherOLED_SH110X_WiFi_H_
 ...
 */
/**************************************************************************/
class Adafruit_FeatherOLED_SH110X_WiFi : public Adafruit_FeatherOLED_SH110X {
private:
...
public:
   ...
   */
  /**************************************************************************/
  Adafruit_FeatherOLED_SH110X_WiFi(TwoWire *wire = &Wire, int reset = -1)
      : Adafruit_FeatherOLED_SH110X(wire, reset) {
    _connected = false;
